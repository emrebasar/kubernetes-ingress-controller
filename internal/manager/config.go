...
type Config struct {
	...
	IngressClassParamsEnabled bool
	ServiceEnabled            bool
...
func (c *Config) FlagSet() *pflag.FlagSet {
	...
	flagSet.BoolVar(&c.IngressClassParamsEnabled, "enable-controller-ingress-class-params", false, "Enable or disable the IngressClassParams controller.")
